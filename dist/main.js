...
export {
  ...
  resolveTransitionHooks as a$,
  getCurrentInstance as a0,
  getCurrentScope as a1,
  getCurrentWatcher as a2,
  getTransitionRawChildren as a3,
  guardReactiveProps as a4,
  h as a5,
  handleError as a6,
  hasInjectionContext as a7,
  hydrate as a8,
  hydrateOnIdle as a9,
  onDeactivated as aA,
  onErrorCaptured as aB,
  onMounted as aC,
  onRenderTracked as aD,
  onRenderTriggered as aE,
  onScopeDispose as aF,
  onServerPrefetch as aG,
  onUnmounted as aH,
  onUpdated as aI,
  onWatcherCleanup as aJ,
  openBlock as aK,
  popScopeId as aL,
  provide as aM,
  proxyRefs as aN,
  pushScopeId as aO,
  queuePostFlushCb as aP,
  reactive as aQ,
  readonly as aR,
  ref as aS,
  registerRuntimeCompiler as aT,
  render as aU,
  renderList as aV,
  renderSlot as aW,
  resolveComponent as aX,
  ...
  mergeProps as ar,
  nextTick as as,
  normalizeClass as at,
  normalizeProps as au,
  normalizeStyle as av,
  onActivated as aw,
  onBeforeMount as ax,
  onBeforeUnmount as ay,
  onBeforeUpdate as az,
  ErrorCodes as b,
  setBlockTracking as b0,
  setDevtoolsHook as b1,
  setTransitionHooks as b2,
  shallowReactive as b3,
  shallowReadonly as b4,
  shallowRef as b5,
  ssrContextKey as b6,
  ssrUtils as b7,
  stop as b8,
  toDisplayString as b9,
  version as bA,
  warn as bB,
  watch as bC,
  watchEffect as bD,
  watchPostEffect as bE,
  watchSyncEffect as bF,
  withAsyncContext as bG,
  withCtx as bH,
  withDefaults as bI,
  withDirectives as bJ,
  withKeys as bK,
  withMemo as bL,
  withModifiers as bM,
  withScopeId as bN,
  ...
  useShadowRoot as bq,
  useSlots as br,
  useTemplateRef as bs,
  useTransitionState as bt,
  vModelCheckbox as bu,
  vModelDynamic as bv,
  vModelRadio as bw,
  vModelSelect as bx,
  vModelText as by,
