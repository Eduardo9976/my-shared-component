...
function getContext(calledFunctionName) {
  const i2 = getCurrentInstance();
  if (!!(process.env.NODE_ENV !== "production") && !i2) {
...
function useModel(props, name, options = EMPTY_OBJ) {
  ...
  if (!!(process.env.NODE_ENV !== "production") && !i2.propsOptions[0][camelizedName]) {
  ...
  _mount(def2) {
    ...
    for (const key in exposed) {
      if (!hasOwn(this, key)) {
        ...
        warn$2(`Exposed property "${key}" already exists on custom element.`);
      }
    }
  }
  _resolveProps(def2) {
...
export {
  ...
  Slot as a1,
  mergeProps as a2,
  createTextVNode as a3,
  toDisplayString as a4,
  createElementBlock as a5,
  createVNode as a6,
  withModifiers as a7,
  Fragment as a8,
  ...
  reactivePick as ae,
  tv as af,
  normalizeClass as ag,
  renderList as ah,
  createBaseVNode as ai,
  _sfc_main$4 as aj,
  _sfc_main$6 as ak,
  resolveDynamicComponent as al,
  _sfc_main$1 as am,
  omit as an,
  shallowReactive as ao,
  useId as ap,
  createApp as aq,
  SharedButtonElement as ar,
  onDeactivated as b,
  createHooks as c,
  onActivated as d,
  computed as e,
