import { a9 as BaseTransition, aa as BaseTransitionPropsValidators, ab as Comment, ac as DeprecationTypes, ad as EffectScope, ae as ErrorCodes, af as ErrorTypeStrings, F as Fragment, ag as KeepAlive, ah as ReactiveEffect, ai as Static, aj as Suspense, T as Teleport, ak as Text, al as TrackOpTypes, am as Transition, an as TransitionGroup, ao as TriggerOpTypes, ap as VueElement, aq as assertNumber, ar as callWithAsyncErrorHandling, as as callWithErrorHandling, at as camelize, au as capitalize, av as cloneVNode, aw as compatUtils, k as computed, a8 as createApp, c as createBlock, g as createCommentVNode, s as createElementBlock, Q as createBaseVNode, ax as createHydrationRenderer, ay as createPropsRestProxy, az as createRenderer, aA as createSSRApp, aB as createSlots, aC as createStaticVNode, h as createTextVNode, v as createVNode, aD as customRef, aE as defineAsyncComponent, d as defineComponent, a6 as defineCustomElement, aF as defineEmits, aG as defineExpose, aH as defineModel, aI as defineOptions, aJ as defineProps, aK as defineSSRCustomElement, aL as defineSlots, aM as devtools, aN as effect, aO as effectScope, aP as getCurrentInstance, aQ as getCurrentScope, aR as getCurrentWatcher, aS as getTransitionRawChildren, B as guardReactiveProps, aT as h, aU as handleError, aV as hasInjectionContext, aW as hydrate, aX as hydrateOnIdle, aY as hydrateOnInteraction, aZ as hydrateOnMediaQuery, a_ as hydrateOnVisible, a$ as initCustomFormatter, b0 as initDirectivesForSSR, b1 as inject, b2 as isMemoSame, b3 as isProxy, b4 as isReactive, b5 as isReadonly, b6 as isRef, b7 as isRuntimeOnly, b8 as isShallow, b9 as isVNode, a2 as markRaw, ba as mergeDefaults, bb as mergeModels, x as mergeProps, I as nextTick, S as normalizeClass, A as normalizeProps, E as normalizeStyle, bc as onActivated, bd as onBeforeMount, be as onBeforeUnmount, bf as onBeforeUpdate, bg as onDeactivated, bh as onErrorCaptured, p as onMounted, bi as onRenderTracked, bj as onRenderTriggered, bk as onScopeDispose, bl as onServerPrefetch, q as onUnmounted, bm as onUpdated, bn as onWatcherCleanup, o as openBlock, bo as popScopeId, a4 as provide, bp as proxyRefs, bq as pushScopeId, br as queuePostFlushCb, a1 as reactive, bs as readonly, b as ref, bt as registerRuntimeCompiler, bu as render, V as renderList, r as renderSlot, bv as resolveComponent, bw as resolveDirective, U as resolveDynamicComponent, bx as resolveFilter, by as resolveTransitionHooks, bz as setBlockTracking, bA as setDevtoolsHook, bB as setTransitionHooks, a0 as shallowReactive, bC as shallowReadonly, bD as shallowRef, bE as ssrContextKey, bF as ssrUtils, bG as stop, i as toDisplayString, bH as toHandlerKey, bI as toHandlers, bJ as toRaw, Y as toRef, t as toRefs, bK as toValue$1, bL as transformVNodeArgs, bM as triggerRef, u as unref, bN as useAttrs, bO as useCssModule, bP as useCssVars, bQ as useHost, a3 as useId$1, bR as useModel, bS as useSSRContext, bT as useShadowRoot, J as useSlots, bU as useTemplateRef, bV as useTransitionState, bW as vModelCheckbox, bX as vModelDynamic, bY as vModelRadio, bZ as vModelSelect, b_ as vModelText, b$ as vShow, c0 as version, c1 as warn, m as watch, l as watchEffect, c2 as watchPostEffect, c3 as watchSyncEffect, c4 as withAsyncContext, w as withCtx, c5 as withDefaults, c6 as withDirectives, c7 as withKeys, c8 as withMemo, y as withModifiers, c9 as withScopeId, P as Primitive, ca as isNullish, cb as isEqual, C as useVModel, a as createContext, j as useForwardExpose, cc as defaultWindow, z as isClient, cd as renderSlotFragments, D as unrefElement, ce as useEventListener, cf as createGlobalState, n as onKeyStroke, cg as useEmitAsProps, ch as createSharedComposable, ci as tryOnBeforeUnmount, cj as defu, ck as isIOS, cl as useMounted, cm as Slot, cn as computedEager, co as refAutoReset, L as useForwardPropsEmits, cp as makeDestructurable, cq as camelize$1, $ as createSharedComposable$1, cr as _export_sfc, K as useLocale, M as reactivePick, N as tv, O as useAppConfig, W as _sfc_main$1b, R as _sfc_main$1c, cs as get, ct as reactiveOmit, Z as omit, cu as isArrayOfArray, _ as _sfc_main$1d, cv as _sfc_main$1e, cw as pickLinkProps, cx as _sfc_main$1f, a7 as tailwindStyles } from "./main.js";
/**
* vue v3.5.18
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$_), {
        ...
        default: withCtx(() => [
          createVNode(unref(_sfc_main$Z), mergeProps({
            id: unref(rootContext).contentId,
            ref: unref(forwardRef),
            as: _ctx.as,
            "as-child": _ctx.asChild,
...
const _sfc_main$X = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$Y, mergeProps({ ...props, ...unref(emitsAsProps) }, {
        ref: unref(forwardRef),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          unref(rootContext).modal.value ? (openBlock(), createBlock(_sfc_main$X, mergeProps({
            key: 0,
            ref: unref(forwardRef)
            ...
            _: 3
          }, 16)) : (openBlock(), createBlock(_sfc_main$W, mergeProps({
            key: 1,
            ref: unref(forwardRef)
          }, { ...props, ...unref(emitsAsProps), ..._ctx.$attrs }), {
            default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(rootContext)?.modal.value ? (openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main$T, mergeProps(_ctx.$attrs, {
            ref: unref(forwardRef),
            as: _ctx.as,
            "as-child": _ctx.asChild
          }), {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        createVNode(_sfc_main$L, mergeProps(_ctx.$attrs, {
          ref: unref(forwardRef),
          style: {
            display: "block"
          },
...
const _sfc_main$E = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$F, mergeProps(props, {
        ref: unref(forwardRef),
...
const _sfc_main$C = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$E, mergeProps({ role: "menuitemcheckbox" }, props, {
...
const _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useHideOthers(currentElement);
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$G, mergeProps(unref(forwarded), {
        ref: unref(forwardRef),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          unref(rootContext).modal.value ? (openBlock(), createBlock(_sfc_main$B, normalizeProps(mergeProps({ key: 0 }, { ..._ctx.$attrs, ...unref(forwarded) })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
          }, 16)) : (openBlock(), createBlock(_sfc_main$A, normalizeProps(mergeProps({ key: 1 }, { ..._ctx.$attrs, ...unref(forwarded) })), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$y, normalizeProps(guardReactiveProps(props)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default", { modelValue: unref(modelValue) })
        ]),
        _: 3
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    provideMenuItemIndicatorContext({ modelValue });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$E, mergeProps({ role: "menuitemradio" }, props, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Presence), {
        ...
        default: withCtx(() => [
          createVNode(_sfc_main$G, mergeProps(unref(forwarded), {
...
const _sfc_main$p = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$q, { "as-child": "" }, {
        default: withCtx(() => [
          createVNode(_sfc_main$F, mergeProps(props, {
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$C), normalizeProps(guardReactiveProps({ ...props, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$z), mergeProps(unref(forwarded), {
        id: unref(rootContext).contentId,
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$v), normalizeProps(guardReactiveProps({ ...props, ...unref(emitsAsProps) })), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$u), normalizeProps(guardReactiveProps(unref(forwarded))), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$t), normalizeProps(guardReactiveProps(props)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    useForwardExpose();
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$r), mergeProps(unref(forwarded), { style: {
        "--reka-dropdown-menu-content-transform-origin": "var(--reka-popper-transform-origin)",
        "--reka-dropdown-menu-content-available-width": "var(--reka-popper-available-width)",
        "--reka-dropdown-menu-content-available-height": "var(--reka-popper-available-height)",
        "--reka-dropdown-menu-trigger-width": "var(--reka-popper-anchor-width)",
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    color: { default: void 0, type: String },
...
const _style_0 = "\n.me-icon-xs[data-v-2bfff6f4] {\n  font-size: 0.75rem !important;\n  width: 0.75rem !important;\n  height: 0.75rem !important;\n}\n.me-icon-sm[data-v-2bfff6f4] {\n  font-size: 0.875rem !important;\n  width: 0.875rem !important;\n  height: 0.875rem !important;\n}\n.me-icon-md[data-v-2bfff6f4] {\n  font-size: 1rem !important;\n  width: 1rem !important;\n  height: 1rem !important;\n}\n.me-icon-lg[data-v-2bfff6f4] {\n  font-size: 1.25rem !important;\n  width: 1.25rem !important;\n  height: 1.25rem !important;\n}\n.me-icon-xl[data-v-2bfff6f4] {\n  font-size: 1.5rem !important;\n  width: 1.5rem !important;\n  height: 1.5rem !important;\n}\n.me-icon-2xl[data-v-2bfff6f4] {\n  font-size: 2rem !important;\n  width: 2rem !important;\n  height: 2rem !important;\n}\n";
const MeIcon = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["styles", [_style_0]], ["__scopeId", "data-v-2bfff6f4"]]);
const meIconStyles = `/*!
...
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$10), normalizeProps(guardReactiveProps(unref(rootProps))), {
        default: withCtx(({ open, close }) => [
          !!slots.default ? (openBlock(), createBlock(unref(_sfc_main$P), {
            key: 0,
            "as-child": "",
          ...
          createVNode(unref(_sfc_main$o), normalizeProps(guardReactiveProps(unref(portalProps))), {
            default: withCtx(() => [
              __props.overlay ? (openBlock(), createBlock(unref(_sfc_main$S), {
                key: 0,
              ...
              createVNode(unref(_sfc_main$V), mergeProps({
                ...
                default: withCtx(() => [
                  !!slots.content && (__props.title || !!slots.title || (__props.description || !!slots.description)) ? (openBlock(), createBlock(unref(_sfc_main$1a), { key: 0 }, {
                    default: withCtx(() => [
                      __props.title || !!slots.title ? (openBlock(), createBlock(unref(_sfc_main$Q), { key: 0 }, {
                        default: withCtx(() => [
                      ...
                      __props.description || !!slots.description ? (openBlock(), createBlock(unref(_sfc_main$U), { key: 1 }, {
                        default: withCtx(() => [
                    ...
                    !!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description) || (props.close || !!slots.close) ? (openBlock(), createElementBlock("div", {
                      ...
                      renderSlot(_ctx.$slots, "header", { close }, () => [
                        createBaseVNode("div", {
                          ...
                          __props.title || !!slots.title ? (openBlock(), createBlock(unref(_sfc_main$Q), {
                            key: 0,
                          ...
                          __props.description || !!slots.description ? (openBlock(), createBlock(unref(_sfc_main$U), {
                            key: 1,
                        ...
                        props.close || !!slots.close ? (openBlock(), createBlock(unref(_sfc_main$$), {
                          key: 0,
                          "as-child": ""
                        }, {
                          default: withCtx(() => [
                            renderSlot(_ctx.$slots, "close", {
                              ...
                              props.close ? (openBlock(), createBlock(_sfc_main$1b, mergeProps({
                                key: 0,
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_UButton = _sfc_main$1b;
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$18), mergeProps(unref(rootProps), {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (item, index) => {
            return openBlock(), createBlock(unref(_sfc_main$16), {
              ...
              default: withCtx(({ open }) => [
                    ...
                    createVNode(unref(_sfc_main$11), {
                      ...
                      default: withCtx(() => [
                        renderSlot(_ctx.$slots, "leading", {
                          ...
                          item.icon ? (openBlock(), createBlock(_sfc_main$1c, {
                            key: 0,
                            name: item.icon,
                ...
                item.content || !!slots.content || item.slot && !!slots[item.slot] || !!slots.body || item.slot && !!slots[`${item.slot}-body`] ? (openBlock(), createBlock(unref(_sfc_main$14), {
                  key: 0,
          ...
          default: withCtx(({ item, active, index }) => [
            renderSlot(_ctx.$slots, item.slot || "item", {
              ...
              renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                ...
                item.loading ? (openBlock(), createBlock(_sfc_main$1c, {
                  key: 0,
                ...
                }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$1c, {
                  key: 1,
                  name: item.icon,
                ...
                }, null, 8, ["name", "class"])) : item.avatar ? (openBlock(), createBlock(_sfc_main$1d, mergeProps({
                  key: 2,
              ...
              unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createElementBlock("span", {
                ...
                item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$1c, {
                  key: 0,
              ...
              createBaseVNode("span", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                  ...
                  item.children?.length ? (openBlock(), createBlock(_sfc_main$1c, {
                    key: 0,
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(group, (item, index) => {
                          return openBlock(), createElementBlock(Fragment, {
                            ...
                            item.type === "label" ? (openBlock(), createBlock(unref(DropdownMenu).Label, {
                              ...
                              default: withCtx(() => [
                                createVNode(_sfc_main$1e, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                  default: withCtx(({ active, ...slotProps }) => [
                                    createVNode(_sfc_main$1f, mergeProps({ ref_for: true }, slotProps, {
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$l), normalizeProps(guardReactiveProps(unref(rootProps))), {
        default: withCtx(({ open }) => [
          !!slots.default ? (openBlock(), createBlock(unref(_sfc_main$8), {
            key: 0,
            "as-child": "",
            class: normalizeClass(props.class),
          ...
          createVNode(_sfc_main$2, mergeProps({
            ...
            default: withCtx(() => [
              !!__props.arrow ? (openBlock(), createBlock(unref(_sfc_main$n), mergeProps({ key: 0 }, arrowProps.value, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_UIcon = _sfc_main$1c;
      const _component_UButton = _sfc_main$1b;
